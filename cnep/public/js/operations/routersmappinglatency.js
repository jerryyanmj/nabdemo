/**
 * This script is used for show data for Routers Mapping Latency page
 */
...
( function ( window, document, $, google ) {
    ...
    // Class RoutersMappingLatency definition
    var RoutersMappingLatency = function() {
        ...
        self.RoutersMappingLatencyData = [];
    ...
    // Google map
    RoutersMappingLatency.prototype.map                 = null;
    RoutersMappingLatency.prototype.mapInitialZoomLevel = 4;

    // Markers cluster
    RoutersMappingLatency.prototype.markersCluster        = null;
    RoutersMappingLatency.prototype.markersClusterOptions = { maxZoom: 7, gridSize: 80 };

    // Markers manager
    RoutersMappingLatency.prototype.markersManager        = null;
    RoutersMappingLatency.prototype.markersManagerOptions = { maxZoom: 7 };

    RoutersMappingLatency.prototype.getMap = function() {
    ...
    RoutersMappingLatency.prototype.createMarker = function( lattitude, longitude, name, type, imageName, zIndex, markerSize, markerLabelClass, markerLabelContent, markerLabelPointX, markerLabelPointY ) {
    ...
    RoutersMappingLatency.prototype.createMap = function( map_canvas, callback ) {
    ...
    RoutersMappingLatency.prototype.clearRouters = function() {
        ...
        if( self.RoutersMappingLatencyData.length > 0 ) { 

            for( var i = 0; i < 3; i++ ) {

		        $.each(
		            self.RoutersMappingLatencyData[ i ][ "markersList" ], 
		            function( index, data ) {
    ...
    RoutersMappingLatency.prototype.createLegend = function() {
    ...
    RoutersMappingLatency.prototype.createControls = function() {
    ...
    RoutersMappingLatency.prototype.createLineChartForInfowindow = function( chart_div_id, chart_data ) {
    ...
    RoutersMappingLatency.prototype.createRoutersMappingLatencyMarkers = function() {
        ...
        if( useClustererFlag == false ) {
	        ...
	        $.each(
	            ...
	            self.RoutersMappingLatencyData[ 0 ][ "markersList" ], 
	        ...
	        self.markersManager.addMarkers( createdMarkersForDivisionLevel, self.RoutersMappingLatencyData[ 0 ][ "zoomRange" ][ 0 ], self.RoutersMappingLatencyData[ 0 ][ "zoomRange" ][ 1 ] );
	
	        // Process zipcodes mapping level
	        $.each(
	
	            self.RoutersMappingLatencyData[ 1 ][ "markersList" ], 
	        ...
	        self.markersManager.addMarkers( createdMarkersForZipcodeLevel, self.RoutersMappingLatencyData[ 1 ][ "zoomRange" ][ 0 ], self.RoutersMappingLatencyData[ 1 ][ "zoomRange" ][ 1 ] );
        ...
        $.each(
            ...
            self.RoutersMappingLatencyData[ 2 ][ "markersList" ], 
            ...
            function( index, data ) {
                ...
                google.maps.event.addListener(
                    ...
                    function() {
                        ...
                        self.createLineChartForInfowindow( "chart_div_" + data.cidr, data.std_latency_count );
        ...
        if( useClustererFlag == false ) {
	        ...
	        self.markersManager.addMarkers( createdMarkersForRoutersLevel, self.RoutersMappingLatencyData[ 2 ][ "zoomRange" ][ 0 ], self.RoutersMappingLatencyData[ 2 ][ "zoomRange" ][ 1 ] );
    ...
    RoutersMappingLatency.prototype.onModuleLoad = function() {
    ...
    RoutersMappingLatency.prototype.getRoutersMappingLatency = function() {
        ...
        $.ajax({
            ...
            url: '/cnep/ajax/get_routers_mapping_latency.json',
            dataType: 'json',
            ...
            success: function( response ) {
                ...
                // Save routers mapping latency data
                self.RoutersMappingLatencyData = response;

                // Create routers mapping markers
                self.createRoutersMappingLatencyMarkers();
    ...
    ( function main () {
        ...
        var routersMappingLatency = new RoutersMappingLatency();
